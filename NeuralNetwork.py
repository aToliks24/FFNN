...
def L_model_backward(AL, Y, caches):
    """
    Description:
    Implement the backward propagation process for the entire network.Some comments:
    ...
    Caches – list of caches containing for each layer: a) the linear cache; b) the activation cache Output:
